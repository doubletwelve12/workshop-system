...
class _UserRatingScreenState extends State<UserRatingScreen>
  ...
  void initState() {
    super.initState();
    print('🔄 DEBUG: Screen initializing...');
  ...
  try {
    ...
    print('✅ DEBUG: Firebase Auth user: ${currentUser?.uid}');
    ...
    // Try to get app user data
    final appUser = await authService.getCurrentAppUser();
    print('✅ DEBUG: App user data: ${appUser?.role}');
    
    if (appUser == null) {
      print('❌ DEBUG: No app user data found - this is where your error occurs');
    }
    
  } catch (e) {
    print('❌ DEBUG: Error in auth check: $e');
  }
}
  ...
  //               GoRouter.of(context).go('/all-ratings');
  //             }
  //           },
  //         ),
  //       ],
